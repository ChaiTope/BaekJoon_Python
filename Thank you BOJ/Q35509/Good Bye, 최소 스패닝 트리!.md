...
 
$N$개의 정점과 
$M$개의 간선으로 이루어진 가중치 있는 무방향 그래프가 주어진다. 정점은 
$1$번부터 
$N$번까지 번호가 붙어 있고, 간선은 
$1$번부터 
$M$번까지 번호가 붙어 있다.
...
다음 
$M$개의 줄에 그래프의 간선을 나타내는 정수 
$u_i,v_i,w_i$가 공백으로 구분되어 주어진다. 
$i$번 간선이 정점 
$u_i$와 
$v_i$를 
$w_i$의 가중치로 이음을 나타낸다.
...
YES를 출력한 경우 다음 
$N-1$개의 줄에 MST를 이루는 간선의 번호를 출력한다.

다음 줄에 MBST이면서 MST가 아닌 것이 있으면 YES, 없으면 NO를 출력한다.

YES를 출력한 경우 다음 
$N-1$개의 줄에 MBST를 이루는 간선의 번호를 출력한다.
